// I, viren Patel,000381431, certify that this material is my
...
using Lab_1B.Models;
using Lab_1B.Models.AccountViewModels;
using Lab_1B.Services;
...
namespace Lab_1B.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        {
            ApplicationUser user1 = new ApplicationUser { Email = "jill@james.com", UserName = "jill@james.com", FirstName = "Jill", LastNAme = "J", BirthDate = DateTime.Now.Date };
            ApplicationUser user2 = new ApplicationUser { Email = "lebron@james.com", UserName = "lebron@james.com", FirstName = "LeBron", LastNAme = "J", BirthDate  = DateTime.Now.Date };
